...
const Billing = () => {
    ...
    const handlePlaceOrder = () => {
        if (firstname && lastname && country && state && city && email && phone && address && zipcode) {
            ...
            // Assuming you have a function to generate order ID
            ...
            dispatch(orderItem(
                ...
                paymentMode,
                orderName,
                orderId,  // Include orderId in the dispatch function
                parseFloat((parseInt(totalPrice) + parseInt(shipping)) - discount).toFixed(2)
            )).then(() => {
    ...
    return (
        <div className='flex flex-col relative'>
            {orderPlaced && <div className='fixed w-full h-screen flex justify-center items-center bg-[#5f5f5f71]'>
                <div className='w-[450px] h-[300px] bg-white shadow-2xl rounded-3xl pt-5 font-dmsans pl-10 pr-10'>
                    <p className='w-full flex h-10 items-center rounded-3xl text-green text-3xl tracking-wide font-bold text-[#267c32] uppercase  justify-center'>Thank You!</p>
            ...
            <div className='flex sm:flex-row flex-col min-h-screen items-center'>
                <div className='h-full w-full sm:pl-10 sm:pr-20 sm:pt-14 pt-5 pl-2'>
                    ...
                    <div className='sm:min-h-[220px] h-[190px] w-full border border-[#1a1a1d3f] rounded-3xl pt-5 mt-5 sm:pr-5 sm:mb-10'>
                        <p className='text-sm font-dmsans ml-2'>Payment Option</p>
                        <form action="" className='flex flex-col sm:pl-9 pl-3 sm:pr-0 pr-3 pt-5 '>
                            <div className='pl-10 h-[100px] w-full border pt-2 pb-2 rounded-3xl border-[#1a1a1d4a] flex'>
